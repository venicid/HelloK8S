...
13. 主机与容器之间拷贝数据
     ...
     $ docke r exec -ti nginx cat /tmp/test.txt
     123
...
# 此时进程的hostname为container
$ hostname

# 子进程查看此时的pid
$ echo $$

# 打开宿主机查看子进程的id和hostname
[root@learn-docker ~]# ps aux |grep 7220
[root@learn-docker ~]# hostname
```
